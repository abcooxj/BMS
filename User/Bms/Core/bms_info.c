...
// thread config
#define INFO_TASK_STACK_SIZE	512	//栈大小
#define INFO_TASK_PRIORITY		13   //优先级
#define INFO_TASK_TIMESLICE		25   //时间片

#define INFO_TASK_PERIOD		2000   //任务时间
